...
export interface CategoryToMemoConnectionWhereArgs {
  /** Category ID */
...
export interface CategoryToNoteConnectionWhereArgs {
...
export interface CreateBlogpostInput {
  ...
  postExcerpt?: InputMaybe<Scalars["String"]>;
  /** For illustration and sorting */
  postLabel?: InputMaybe<Scalars["String"]>;
...
export interface CreateMynoteInput {
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars["ID"]>;
...
export interface CreateNoteInput {
  acfCategory?: InputMaybe<Scalars["String"]>;
  acfDetails?: InputMaybe<Scalars["String"]>;
  acfImportance?: InputMaybe<Scalars["Int"]>;
  acfIspublic?: InputMaybe<Scalars["Boolean"]>;
  acfMakepublic?: InputMaybe<Scalars["Boolean"]>;
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars["ID"]>;
...
export interface DeleteMynoteInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars["Boolean"]>;
...
export interface DeleteNoteCategoryInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
...
export interface DeleteSnippetInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars["Boolean"]>;
...
export interface MemoCategoriesInput {
...
export interface MemoCategoriesNodeInput {
...
export interface MemoTagsInput {
...
export interface MemoTagsNodeInput {
...
export interface MemoToCategoryConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface MemoToTagConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface MemoToTermNodeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface MynoteNoteCategoriesInput {
...
export interface MynoteNoteCategoriesNodeInput {
...
export interface MynoteToNoteCategoryConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface MynoteToTermNodeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface NoteCategoriesInput {
  /** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars["Boolean"]>;
  /** The input list of items to set. */
...
export interface NoteCategoriesNodeInput {
  /** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
  description?: InputMaybe<Scalars["String"]>;
...
export interface NoteCategoryToContentNodeConnectionWhereArgs {
  /** The Types of content to filter */
...
export interface NoteCategoryToMynoteConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface NoteTagsNodeInput {
  /** The description of the tag. This field is used to set a description of the tag if a new one is created during the mutation. */
  description?: InputMaybe<Scalars["String"]>;
...
export interface NoteToCategoryConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface NoteToTagConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface NoteToTermNodeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface RootQueryToBlogpostConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface RootQueryToCreatorConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface RootQueryToFoodConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface RootQueryToIngredientConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface RootQueryToMemoConnectionWhereArgs {
  /** Category ID */
  categoryId?: InputMaybe<Scalars["Int"]>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface RootQueryToMynoteConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface RootQueryToNoteCategoryConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export interface RootQueryToNoteConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface RootQueryToRecipeConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface RootQueryToSnippetConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface TagToMemoConnectionWhereArgs {
  /** Category ID */
  categoryId?: InputMaybe<Scalars["Int"]>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface TagToNoteConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface UpdateCreatorInput {
  ...
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The URL of the creator */
  creatorURL?: InputMaybe<Scalars["String"]>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars["String"]>;
...
export interface UpdateMynoteInput {
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars["ID"]>;
  /** Used for categories instead of usesing WP standard categories, just for testing - to be changed */
  category?: InputMaybe<Scalars["String"]>;
  ...
  slug?: InputMaybe<Scalars["String"]>;
  /** This field can be used to change the sorting order */
  sortingOrder?: InputMaybe<Scalars["Float"]>;
  /** The status of the object */
  status?: InputMaybe<PostStatusEnum>;
  /** The title of the object */
  title?: InputMaybe<Scalars["String"]>;
...
export interface UpdateRecipeInput {
  ...
  password?: InputMaybe<Scalars["String"]>;
  /** The URL of the recipe */
  recipeURL?: InputMaybe<Scalars["String"]>;
  /** The slug of the object */
  slug?: InputMaybe<Scalars["String"]>;
  /** The status of the object */
  status?: InputMaybe<PostStatusEnum>;
...
export interface UserToBlogpostConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface UserToCreatorConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface UserToFoodConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface UserToIngredientConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface UserToMynoteConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface UserToNoteConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface UserToRecipeConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export interface UserToSnippetConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
export const scalarsEnumsHash: import("gqty").ScalarsEnumsHash = {
  ...
  ContentTypesOfNoteCategoryEnum: true,
...
export const generatedSchema = {
  ...
  Blogpost: {
    ...
    name: { __type: "String" },
    postExcerpt: { __type: "String" },
    postLabel: { __type: "String" },
    preview: { __type: "BlogpostToPreviewConnectionEdge" },
  ...
  Category: {
    ...
    link: { __type: "String" },
    memos: {
      __type: "CategoryToMemoConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "CategoryToMemoConnectionWhereArgs",
      },
    },
    name: { __type: "String" },
    notes: {
      __type: "CategoryToNoteConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "CategoryToNoteConnectionWhereArgs",
      },
    },
  ...
  CategoryToMemoConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[CategoryToMemoConnectionEdge]" },
    nodes: { __type: "[Memo]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  CategoryToMemoConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Memo" },
  },
  CategoryToMemoConnectionWhereArgs: {
    categoryId: { __type: "Int" },
  ...
  CategoryToNoteConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[CategoryToNoteConnectionEdge]" },
    nodes: { __type: "[Note]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  CategoryToNoteConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Note" },
  },
  CategoryToNoteConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
  ...
  CreateMemoInput: {
    categories: { __type: "MemoCategoriesInput" },
    clientMutationId: { __type: "String" },
    content: { __type: "String" },
    date: { __type: "String" },
    menuOrder: { __type: "Int" },
  ...
  CreateMynoteInput: {
    ...
    menuOrder: { __type: "Int" },
    name: { __type: "String!" },
    noteCategories: { __type: "MynoteNoteCategoriesInput" },
    password: { __type: "String" },
    publish: { __type: "Boolean" },
    slug: { __type: "String" },
    sortingOrder: { __type: "Float!" },
    status: { __type: "PostStatusEnum" },
    title: { __type: "String" },
  },
  CreateMynotePayload: {
  ...
  CreateNoteCategoryPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    noteCategory: { __type: "NoteCategory" },
  },
  CreateNoteInput: {
    acfCategory: { __type: "String" },
    acfDetails: { __type: "String" },
    acfImportance: { __type: "Int" },
    acfIspublic: { __type: "Boolean" },
    acfMakepublic: { __type: "Boolean" },
    authorId: { __type: "ID" },
    categories: { __type: "NoteCategoriesInput" },
    clientMutationId: { __type: "String" },
    content: { __type: "String" },
    date: { __type: "String" },
    menuOrder: { __type: "Int" },
  ...
  Creator: {
    ...
    modifiedGmt: { __type: "String" },
    name: { __type: "String" },
    preview: { __type: "CreatorToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    recipes: {
      __type: "CreatorToRecipeConnection",
      __args: { after: "String", before: "String", first: "Int", last: "Int" },
    },
    slug: { __type: "String" },
    status: { __type: "String" },
  ...
  CreatorToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Creator" },
  },
  CreatorToRecipeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[CreatorToRecipeConnectionEdge]" },
    nodes: { __type: "[Recipe]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  CreatorToRecipeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Recipe" },
  },
  ...
  DeleteNoteCategoryInput: {
    clientMutationId: { __type: "String" },
    id: { __type: "ID!" },
  },
  DeleteNoteCategoryPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    deletedId: { __type: "ID" },
    noteCategory: { __type: "NoteCategory" },
  ...
  Food: {
    ...
    id: { __type: "ID!" },
    ingredients: {
      __type: "FoodToIngredientConnection",
      __args: { after: "String", before: "String", first: "Int", last: "Int" },
    },
    isContentNode: { __type: "Boolean!" },
    isPreview: { __type: "Boolean" },
    ...
    modifiedGmt: { __type: "String" },
    name: { __type: "String" },
    preview: { __type: "FoodToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    slug: { __type: "String" },
    status: { __type: "String" },
  ...
  FoodToIngredientConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[FoodToIngredientConnectionEdge]" },
    nodes: { __type: "[Ingredient]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  FoodToIngredientConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Ingredient" },
  },
  FoodToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Food" },
  },
  GeneralSettings: {
  ...
  Ingredient: {
    ...
    guid: { __type: "String" },
    id: { __type: "ID!" },
    ingredientFood: { __type: "IngredientToFoodConnectionEdge" },
    ingredientId: { __type: "Int!" },
    isContentNode: { __type: "Boolean!" },
    isPreview: { __type: "Boolean" },
    isRestricted: { __type: "Boolean" },
    isTermNode: { __type: "Boolean!" },
    ...
    modifiedGmt: { __type: "String" },
    name: { __type: "String" },
    preview: { __type: "IngredientToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    recipes: {
      __type: "IngredientToRecipeConnection",
      __args: { after: "String", before: "String", first: "Int", last: "Int" },
    },
    slug: { __type: "String" },
    status: { __type: "String" },
  ...
  IngredientToFoodConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Food" },
  },
  IngredientToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Ingredient" },
  },
  IngredientToRecipeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[IngredientToRecipeConnectionEdge]" },
    nodes: { __type: "[Recipe]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  IngredientToRecipeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Recipe" },
  },
  LoginWithCookiesInput: {
    clientMutationId: { __type: "String" },
    login: { __type: "String!" },
    password: { __type: "String!" },
    rememberMe: { __type: "Boolean" },
  },
  ...
  LogoutInput: { clientMutationId: { __type: "String" } },
  LogoutPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    status: { __type: "String" },
  ...
  Memo: {
    __typename: { __type: "String!" },
    categories: {
      __type: "MemoToCategoryConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "MemoToCategoryConnectionWhereArgs",
      },
    },
    conditionalTags: { __type: "ConditionalTags" },
    content: {
    ...
    link: { __type: "String" },
    memoId: { __type: "Int!" },
    memos: { __type: "Memo_Memos" },
    modified: { __type: "String" },
    modifiedGmt: { __type: "String" },
    preview: { __type: "MemoToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    slug: { __type: "String" },
    status: { __type: "String" },
    tags: {
      __type: "MemoToTagConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "MemoToTagConnectionWhereArgs",
      },
    },
    template: { __type: "ContentTemplate" },
    templates: { __type: "[String]" },
    terms: {
      __type: "MemoToTermNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "MemoToTermNodeConnectionWhereArgs",
      },
    },
    title: {
      __type: "String",
  ...
  MemoCategoriesInput: {
    ...
    nodes: { __type: "[MemoCategoriesNodeInput]" },
  },
  MemoCategoriesNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
    name: { __type: "String" },
    slug: { __type: "String" },
  ...
  MemoTagsInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[MemoTagsNodeInput]" },
  },
  MemoTagsNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
  ...
  MemoToCategoryConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[MemoToCategoryConnectionEdge]" },
    nodes: { __type: "[Category]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  MemoToCategoryConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Category" },
  },
  MemoToCategoryConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  MemoToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Memo" },
  },
  MemoToTagConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[MemoToTagConnectionEdge]" },
    nodes: { __type: "[Tag]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  MemoToTagConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Tag" },
  },
  MemoToTagConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  MemoToTermNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[MemoToTermNodeConnectionEdge]" },
    nodes: { __type: "[TermNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  MemoToTermNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "TermNode" },
  },
  MemoToTermNodeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  Memo_Memos: {
    __typename: { __type: "String!" },
    fieldGroupName: { __type: "String" },
    memoArchived: { __type: "Boolean" },
    memoCategory: { __type: "String" },
    memoContent: { __type: "String" },
    memoExcerpt: { __type: "String" },
    memoImportance: { __type: "Float" },
    memoScore: { __type: "Float" },
  },
  Menu: {
    __typename: { __type: "String!" },
    count: { __type: "Int" },
  ...
  Mynote: {
    ...
    name: { __type: "String" },
    noteCategories: {
      __type: "MynoteToNoteCategoryConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "MynoteToNoteCategoryConnectionWhereArgs",
      },
    },
    preview: { __type: "MynoteToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    publish: { __type: "Boolean" },
    slug: { __type: "String" },
    ...
    templates: { __type: "[String]" },
    terms: {
      __type: "MynoteToTermNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "MynoteToTermNodeConnectionWhereArgs",
      },
    },
    title: {
      __type: "String",
  ...
  MynoteNoteCategoriesInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[MynoteNoteCategoriesNodeInput]" },
  },
  MynoteNoteCategoriesNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
    name: { __type: "String" },
    slug: { __type: "String" },
  },
  MynoteToNoteCategoryConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[MynoteToNoteCategoryConnectionEdge]" },
    nodes: { __type: "[NoteCategory]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  MynoteToNoteCategoryConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "NoteCategory" },
  },
  MynoteToNoteCategoryConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  MynoteToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Mynote" },
  },
  MynoteToTermNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[MynoteToTermNodeConnectionEdge]" },
    nodes: { __type: "[TermNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  MynoteToTermNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "TermNode" },
  },
  MynoteToTermNodeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  Note: {
    ...
    authorId: { __type: "ID" },
    categories: {
      __type: "NoteToCategoryConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "NoteToCategoryConnectionWhereArgs",
      },
    },
    conditionalTags: { __type: "ConditionalTags" },
    content: {
    ...
    modified: { __type: "String" },
    modifiedGmt: { __type: "String" },
    noteAcf: { __type: "Note_Noteacf" },
    noteId: { __type: "Int!" },
    preview: { __type: "NoteToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    slug: { __type: "String" },
    status: { __type: "String" },
    tags: {
      __type: "NoteToTagConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "NoteToTagConnectionWhereArgs",
      },
    },
    template: { __type: "ContentTemplate" },
    templates: { __type: "[String]" },
    terms: {
      __type: "NoteToTermNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "NoteToTermNodeConnectionWhereArgs",
      },
    },
    title: {
      __type: "String",
  ...
  NoteCategoriesInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[NoteCategoriesNodeInput]" },
  },
  NoteCategoriesNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
    name: { __type: "String" },
    slug: { __type: "String" },
  ...
  NoteCategory: {
    ...
    conditionalTags: { __type: "ConditionalTags" },
    contentNodes: {
      __type: "NoteCategoryToContentNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "NoteCategoryToContentNodeConnectionWhereArgs",
      },
    },
    count: { __type: "Int" },
    databaseId: { __type: "Int!" },
    ...
    link: { __type: "String" },
    mynotes: {
      __type: "NoteCategoryToMynoteConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "NoteCategoryToMynoteConnectionWhereArgs",
      },
    },
    name: { __type: "String" },
    noteCategoryId: { __type: "Int" },
    slug: { __type: "String" },
    taxonomy: { __type: "NoteCategoryToTaxonomyConnectionEdge" },
    taxonomyName: { __type: "String" },
    templates: { __type: "[String]" },
    termGroupId: { __type: "Int" },
    termTaxonomyId: { __type: "Int" },
  ...
  NoteCategoryToContentNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[NoteCategoryToContentNodeConnectionEdge]" },
    nodes: { __type: "[ContentNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  NoteCategoryToContentNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "ContentNode" },
  },
  NoteCategoryToContentNodeConnectionWhereArgs: {
    contentTypes: { __type: "[ContentTypesOfNoteCategoryEnum]" },
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  NoteCategoryToMynoteConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[NoteCategoryToMynoteConnectionEdge]" },
    nodes: { __type: "[Mynote]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  NoteCategoryToMynoteConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Mynote" },
  },
  NoteCategoryToMynoteConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  NoteCategoryToTaxonomyConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Taxonomy" },
  },
  NoteTagsInput: {
    append: { __type: "Boolean" },
    nodes: { __type: "[NoteTagsNodeInput]" },
  },
  NoteTagsNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
  ...
  NoteToCategoryConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[NoteToCategoryConnectionEdge]" },
    nodes: { __type: "[Category]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  NoteToCategoryConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Category" },
  },
  NoteToCategoryConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  NoteToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Note" },
  },
  NoteToTagConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[NoteToTagConnectionEdge]" },
    nodes: { __type: "[Tag]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  NoteToTagConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Tag" },
  },
  NoteToTagConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  NoteToTermNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[NoteToTermNodeConnectionEdge]" },
    nodes: { __type: "[TermNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  NoteToTermNodeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "TermNode" },
  },
  NoteToTermNodeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  Post_Acf: {
    __typename: { __type: "String!" },
    fieldGroupName: { __type: "String" },
    imageCapture: { __type: "String" },
    markdown: { __type: "String" },
    markdownTest: { __type: "String" },
  },
  ReadingSettings: {
    __typename: { __type: "String!" },
  ...
  Recipe: {
    ...
    modifiedGmt: { __type: "String" },
    name: { __type: "String" },
    preview: { __type: "RecipeToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    recipeCreator: { __type: "RecipeToCreatorConnectionEdge" },
    recipeId: { __type: "Int!" },
    recipeImage: { __type: "MediaItem" },
    recipeIngredients: {
      __type: "RecipeToIngredientConnection",
      __args: { after: "String", before: "String", first: "Int", last: "Int" },
    },
    recipeURL: { __type: "String" },
    slug: { __type: "String" },
  ...
  RecipeToCreatorConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Creator" },
  },
  RecipeToIngredientConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RecipeToIngredientConnectionEdge]" },
    nodes: { __type: "[Ingredient]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RecipeToIngredientConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Ingredient" },
  },
  RecipeToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Recipe" },
  },
  RegisterUserInput: {
  ...
  RootQueryToBlogpostConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToBlogpostConnectionEdge]" },
    nodes: { __type: "[Blogpost]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToBlogpostConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Blogpost" },
  },
  RootQueryToBlogpostConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToCreatorConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToCreatorConnectionEdge]" },
    nodes: { __type: "[Creator]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToCreatorConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Creator" },
  },
  RootQueryToCreatorConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToFoodConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToFoodConnectionEdge]" },
    nodes: { __type: "[Food]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToFoodConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Food" },
  },
  RootQueryToFoodConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToIngredientConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToIngredientConnectionEdge]" },
    nodes: { __type: "[Ingredient]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToIngredientConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Ingredient" },
  },
  RootQueryToIngredientConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToMemoConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToMemoConnectionEdge]" },
    nodes: { __type: "[Memo]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToMemoConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Memo" },
  },
  RootQueryToMemoConnectionWhereArgs: {
    categoryId: { __type: "Int" },
    categoryIn: { __type: "[ID]" },
    categoryName: { __type: "String" },
    categoryNotIn: { __type: "[ID]" },
  ...
  RootQueryToMynoteConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToMynoteConnectionEdge]" },
    nodes: { __type: "[Mynote]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToMynoteConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Mynote" },
  },
  RootQueryToMynoteConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToNoteCategoryConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToNoteCategoryConnectionEdge]" },
    nodes: { __type: "[NoteCategory]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToNoteCategoryConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "NoteCategory" },
  },
  RootQueryToNoteCategoryConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  RootQueryToNoteConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToNoteConnectionEdge]" },
    nodes: { __type: "[Note]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToNoteConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Note" },
  },
  RootQueryToNoteConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToRecipeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToRecipeConnectionEdge]" },
    nodes: { __type: "[Recipe]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToRecipeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Recipe" },
  },
  RootQueryToRecipeConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToSnippetConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToSnippetConnectionEdge]" },
    nodes: { __type: "[Snippet]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToSnippetConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Snippet" },
  },
  RootQueryToSnippetConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  Snippet: {
    ...
    modifiedGmt: { __type: "String" },
    name: { __type: "String" },
    preview: { __type: "SnippetToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    slug: { __type: "String" },
    snippetId: { __type: "Int!" },
    status: { __type: "String" },
    template: { __type: "ContentTemplate" },
    templates: { __type: "[String]" },
    title: {
  ...
  SnippetToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Snippet" },
  },
  Tag: {
    ...
    link: { __type: "String" },
    memos: {
      __type: "TagToMemoConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "TagToMemoConnectionWhereArgs",
      },
    },
    name: { __type: "String" },
    notes: {
      __type: "TagToNoteConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "TagToNoteConnectionWhereArgs",
      },
    },
    posts: {
  ...
  TagToMemoConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[TagToMemoConnectionEdge]" },
    nodes: { __type: "[Memo]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  TagToMemoConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Memo" },
  },
  TagToMemoConnectionWhereArgs: {
    categoryId: { __type: "Int" },
    categoryIn: { __type: "[ID]" },
    categoryName: { __type: "String" },
    categoryNotIn: { __type: "[ID]" },
  ...
  TagToNoteConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[TagToNoteConnectionEdge]" },
    nodes: { __type: "[Note]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  TagToNoteConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Note" },
  },
  TagToNoteConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  User: {
    ...
    blogposts: {
      __type: "UserToBlogpostConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToBlogpostConnectionWhereArgs",
      },
    },
    ...
    conditionalTags: { __type: "ConditionalTags" },
    creators: {
      __type: "UserToCreatorConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToCreatorConnectionWhereArgs",
      },
    },
    databaseId: { __type: "Int!" },
    description: { __type: "String" },
    ...
    firstName: { __type: "String" },
    foods: {
      __type: "UserToFoodConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToFoodConnectionWhereArgs",
      },
    },
    id: { __type: "ID!" },
    ingredients: {
      __type: "UserToIngredientConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToIngredientConnectionWhereArgs",
      },
    },
    isContentNode: { __type: "Boolean!" },
    isRestricted: { __type: "Boolean" },
    ...
    mynotes: {
      __type: "UserToMynoteConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToMynoteConnectionWhereArgs",
      },
    },
    name: { __type: "String" },
    nicename: { __type: "String" },
    nickname: { __type: "String" },
    notes: {
      __type: "UserToNoteConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToNoteConnectionWhereArgs",
      },
    },
    pages: {
    ...
    recipes: {
      __type: "UserToRecipeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToRecipeConnectionWhereArgs",
      },
    },
    ...
    slug: { __type: "String" },
    snippets: {
      __type: "UserToSnippetConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "UserToSnippetConnectionWhereArgs",
      },
    },
    templates: { __type: "[String]" },
    uri: { __type: "String" },
  ...
  UserToBlogpostConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToBlogpostConnectionEdge]" },
    nodes: { __type: "[Blogpost]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToBlogpostConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Blogpost" },
  },
  UserToBlogpostConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToCreatorConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToCreatorConnectionEdge]" },
    nodes: { __type: "[Creator]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToCreatorConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Creator" },
  },
  UserToCreatorConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToFoodConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToFoodConnectionEdge]" },
    nodes: { __type: "[Food]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToFoodConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Food" },
  },
  UserToFoodConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToIngredientConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToIngredientConnectionEdge]" },
    nodes: { __type: "[Ingredient]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToIngredientConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Ingredient" },
  },
  UserToIngredientConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToMynoteConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToMynoteConnectionEdge]" },
    nodes: { __type: "[Mynote]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToMynoteConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Mynote" },
  },
  UserToMynoteConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToNoteConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToNoteConnectionEdge]" },
    nodes: { __type: "[Note]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToNoteConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Note" },
  },
  UserToNoteConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToRecipeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToRecipeConnectionEdge]" },
    nodes: { __type: "[Recipe]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToRecipeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Recipe" },
  },
  UserToRecipeConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToSnippetConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToSnippetConnectionEdge]" },
    nodes: { __type: "[Snippet]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToSnippetConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Snippet" },
  },
  UserToSnippetConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  mutation: {
    __typename: { __type: "String!" },
    createBlogpost: {
      __type: "CreateBlogpostPayload",
      __args: { input: "CreateBlogpostInput!" },
    },
    createCategory: {
    ...
    createCreator: {
      __type: "CreateCreatorPayload",
      __args: { input: "CreateCreatorInput!" },
    },
    createFood: {
      __type: "CreateFoodPayload",
      __args: { input: "CreateFoodInput!" },
    },
    createIngredient: {
      __type: "CreateIngredientPayload",
      __args: { input: "CreateIngredientInput!" },
    },
    createMediaItem: {
    ...
    createMemo: {
      __type: "CreateMemoPayload",
      __args: { input: "CreateMemoInput!" },
    },
    createMynote: {
      __type: "CreateMynotePayload",
      __args: { input: "CreateMynoteInput!" },
    },
    createNote: {
      __type: "CreateNotePayload",
      __args: { input: "CreateNoteInput!" },
    },
    createNoteCategory: {
      __type: "CreateNoteCategoryPayload",
      __args: { input: "CreateNoteCategoryInput!" },
    },
    createPage: {
    ...
    createRecipe: {
      __type: "CreateRecipePayload",
      __args: { input: "CreateRecipeInput!" },
    },
    createSnippet: {
      __type: "CreateSnippetPayload",
      __args: { input: "CreateSnippetInput!" },
    },
    createTag: {
    ...
    deleteBlogpost: {
      __type: "DeleteBlogpostPayload",
      __args: { input: "DeleteBlogpostInput!" },
    },
    deleteCategory: {
    ...
    deleteCreator: {
      __type: "DeleteCreatorPayload",
      __args: { input: "DeleteCreatorInput!" },
    },
    deleteFood: {
      __type: "DeleteFoodPayload",
      __args: { input: "DeleteFoodInput!" },
    },
    deleteIngredient: {
      __type: "DeleteIngredientPayload",
      __args: { input: "DeleteIngredientInput!" },
    },
    deleteMediaItem: {
    ...
    deleteMemo: {
      __type: "DeleteMemoPayload",
      __args: { input: "DeleteMemoInput!" },
    },
    deleteMynote: {
      __type: "DeleteMynotePayload",
      __args: { input: "DeleteMynoteInput!" },
    },
    deleteNote: {
      __type: "DeleteNotePayload",
      __args: { input: "DeleteNoteInput!" },
    },
    deleteNoteCategory: {
      __type: "DeleteNoteCategoryPayload",
      __args: { input: "DeleteNoteCategoryInput!" },
    },
    deletePage: {
    ...
    deleteRecipe: {
      __type: "DeleteRecipePayload",
      __args: { input: "DeleteRecipeInput!" },
    },
    deleteSnippet: {
      __type: "DeleteSnippetPayload",
      __args: { input: "DeleteSnippetInput!" },
    },
    deleteTag: {
    ...
    loginWithCookies: {
      __type: "LoginWithCookiesPayload",
      __args: { input: "LoginWithCookiesInput!" },
    },
    logout: { __type: "LogoutPayload", __args: { input: "LogoutInput!" } },
    registerUser: {
    ...
    updateBlogpost: {
      __type: "UpdateBlogpostPayload",
      __args: { input: "UpdateBlogpostInput!" },
    },
    updateCategory: {
    ...
    updateCreator: {
      __type: "UpdateCreatorPayload",
      __args: { input: "UpdateCreatorInput!" },
    },
    updateFood: {
      __type: "UpdateFoodPayload",
      __args: { input: "UpdateFoodInput!" },
    },
    updateIngredient: {
      __type: "UpdateIngredientPayload",
      __args: { input: "UpdateIngredientInput!" },
    },
    updateMediaItem: {
    ...
    updateMemo: {
      __type: "UpdateMemoPayload",
      __args: { input: "UpdateMemoInput!" },
    },
    updateMynote: {
      __type: "UpdateMynotePayload",
      __args: { input: "UpdateMynoteInput!" },
    },
    updateNote: {
      __type: "UpdateNotePayload",
      __args: { input: "UpdateNoteInput!" },
    },
    updateNoteCategory: {
      __type: "UpdateNoteCategoryPayload",
      __args: { input: "UpdateNoteCategoryInput!" },
    },
    updatePage: {
    ...
    updateRecipe: {
      __type: "UpdateRecipePayload",
      __args: { input: "UpdateRecipeInput!" },
    },
    updateSettings: {
    ...
    updateSnippet: {
      __type: "UpdateSnippetPayload",
      __args: { input: "UpdateSnippetInput!" },
    },
    updateTag: {
  ...
  query: {
    ...
    blogpost: {
      __type: "Blogpost",
      __args: { asPreview: "Boolean", id: "ID!", idType: "BlogpostIdType" },
    },
    blogpostBy: {
      __type: "Blogpost",
      __args: { blogpostId: "Int", id: "ID", slug: "String", uri: "String" },
    },
    blogposts: {
      __type: "RootQueryToBlogpostConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToBlogpostConnectionWhereArgs",
      },
    },
    categories: {
    ...
    creator: {
      __type: "Creator",
      __args: { asPreview: "Boolean", id: "ID!", idType: "CreatorIdType" },
    },
    creatorBy: {
      __type: "Creator",
      __args: { creatorId: "Int", id: "ID", slug: "String", uri: "String" },
    },
    creators: {
      __type: "RootQueryToCreatorConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToCreatorConnectionWhereArgs",
      },
    },
    discussionSettings: { __type: "DiscussionSettings" },
    food: {
      __type: "Food",
      __args: { asPreview: "Boolean", id: "ID!", idType: "FoodIdType" },
    },
    foodBy: {
      __type: "Food",
      __args: { foodId: "Int", id: "ID", slug: "String", uri: "String" },
    },
    foods: {
      __type: "RootQueryToFoodConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToFoodConnectionWhereArgs",
      },
    },
    generalSettings: { __type: "GeneralSettings" },
    ingredient: {
      __type: "Ingredient",
      __args: { asPreview: "Boolean", id: "ID!", idType: "IngredientIdType" },
    },
    ingredientBy: {
      __type: "Ingredient",
      __args: { id: "ID", ingredientId: "Int", slug: "String", uri: "String" },
    },
    ingredients: {
      __type: "RootQueryToIngredientConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToIngredientConnectionWhereArgs",
      },
    },
    mediaItem: {
      __type: "MediaItem",
    ...
    memo: {
      __type: "Memo",
      __args: { asPreview: "Boolean", id: "ID!", idType: "MemoIdType" },
    },
    memoBy: {
      __type: "Memo",
      __args: { id: "ID", memoId: "Int", slug: "String", uri: "String" },
    },
    memos: {
      __type: "RootQueryToMemoConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToMemoConnectionWhereArgs",
      },
    },
    menu: {
      __type: "Menu",
    ...
    mynote: {
      __type: "Mynote",
      __args: { asPreview: "Boolean", id: "ID!", idType: "MynoteIdType" },
    },
    mynoteBy: {
      __type: "Mynote",
      __args: { id: "ID", mynoteId: "Int", slug: "String", uri: "String" },
    },
    mynotes: {
      __type: "RootQueryToMynoteConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToMynoteConnectionWhereArgs",
      },
    },
    ...
    note: {
      __type: "Note",
      __args: { asPreview: "Boolean", id: "ID!", idType: "NoteIdType" },
    },
    noteBy: {
      __type: "Note",
      __args: { id: "ID", noteId: "Int", slug: "String", uri: "String" },
    },
    noteCategories: {
      __type: "RootQueryToNoteCategoryConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToNoteCategoryConnectionWhereArgs",
      },
    },
    noteCategory: {
      __type: "NoteCategory",
      __args: { id: "ID!", idType: "NoteCategoryIdType" },
    },
    notes: {
      __type: "RootQueryToNoteConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToNoteConnectionWhereArgs",
      },
    },
    page: {
      __type: "Page",
    ...
    recipe: {
      __type: "Recipe",
      __args: { asPreview: "Boolean", id: "ID!", idType: "RecipeIdType" },
    },
    recipeBy: {
      __type: "Recipe",
      __args: { id: "ID", recipeId: "Int", slug: "String", uri: "String" },
    },
    recipes: {
      __type: "RootQueryToRecipeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToRecipeConnectionWhereArgs",
      },
    },
    registeredScripts: {
    ...
    snippet: {
      __type: "Snippet",
      __args: { asPreview: "Boolean", id: "ID!", idType: "SnippetIdType" },
    },
    snippetBy: {
      __type: "Snippet",
      __args: { id: "ID", slug: "String", snippetId: "Int", uri: "String" },
    },
    snippets: {
      __type: "RootQueryToSnippetConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToSnippetConnectionWhereArgs",
      },
    },
  ...
  [SchemaUnionsKey]: {
    ...
    TermNode: ["Category", "NoteCategory", "PostFormat", "Tag"],
    ...
    NodeWithContentEditor: ["Memo", "Note", "Page", "Post"],
    NodeWithFeaturedImage: ["Memo", "Page", "Post", "Recipe"],
    AcfFieldGroup: ["Memo_Memos", "Note_Noteacf", "Post_Acf"],
    MenuItemObjectUnion: [
      "Category",
      "Memo",
      "Note",
...
export interface AcfFieldGroup {
  __typename?: "Memo_Memos" | "Note_Noteacf" | "Post_Acf";
  /**
...
export interface Blogpost {
   ...
   * The blog in Markdown format
   */
  markdown?: Maybe<ScalarsEnums["String"]>;
  /**
   ...
   * A short excerpt  (max 100 characters)
   */
  postExcerpt?: Maybe<ScalarsEnums["String"]>;
  /**
   * For illustration and sorting
   */
  postLabel?: Maybe<ScalarsEnums["String"]>;
  /**
 ...
 * Connection between the blogpost type and the blogpost type
 */
export interface BlogpostToPreviewConnectionEdge {
...
export interface Category {
  ...
  memos: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<CategoryToMemoConnectionWhereArgs>;
  }) => Maybe<CategoryToMemoConnection>;
  /**
  ...
  notes: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<CategoryToNoteConnectionWhereArgs>;
  }) => Maybe<CategoryToNoteConnection>;
  /**
   * Connection between the category type and the category type
   */
 ...
 * Connection between the category type and the Memo type
 */
export interface CategoryToMemoConnection {
  __typename?: "CategoryToMemoConnection";
  /**
   * Edges for the CategoryToMemoConnection connection
   */
  edges?: Maybe<Array<Maybe<CategoryToMemoConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Memo>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface CategoryToMemoConnectionEdge {
 ...
 * Connection between the category type and the Note type
 */
export interface CategoryToNoteConnection {
  __typename?: "CategoryToNoteConnection";
  /**
   * Edges for the CategoryToNoteConnection connection
   */
  edges?: Maybe<Array<Maybe<CategoryToNoteConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface CategoryToNoteConnectionEdge {
 ...
 */
export interface CreateMynotePayload {
 ...
 */
export interface CreateNoteCategoryPayload {
...
export interface Creator {
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  creatorId: ScalarsEnums["Int"];
  /**
   * The URL of the creator
   */
  creatorURL?: Maybe<ScalarsEnums["String"]>;
  /**
   * The unique identifier stored in the database
   */
  databaseId: ScalarsEnums["Int"];
  ...
  recipes: (args?: {
     ...
     */
    last?: Maybe<Scalars["Int"]>;
  }) => Maybe<CreatorToRecipeConnection>;
  /**
   * The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the creator type and the creator type
 */
export interface CreatorToPreviewConnectionEdge {
 ...
 * Connection between the creator type and the recipe type
 */
export interface CreatorToRecipeConnection {
  __typename?: "CreatorToRecipeConnection";
  /**
   * Edges for the CreatorToRecipeConnection connection
   */
  edges?: Maybe<Array<Maybe<CreatorToRecipeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface CreatorToRecipeConnectionEdge {
 ...
 */
export interface DeleteFoodPayload {
 ...
 */
export interface DeleteMynotePayload {
 ...
 */
export interface DeleteNoteCategoryPayload {
...
export interface Food {
   ...
   * Net carbs per 100g
   */
  carbs?: Maybe<ScalarsEnums["Float"]>;
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
  ...
  ingredients: (args?: {
     ...
     */
    last?: Maybe<Scalars["Int"]>;
  }) => Maybe<FoodToIngredientConnection>;
  /**
   * Whether the node is a Content Node
   */
  isContentNode: ScalarsEnums["Boolean"];
 ...
 * Connection between the food type and the ingredient type
 */
export interface FoodToIngredientConnection {
  __typename?: "FoodToIngredientConnection";
  /**
   * Edges for the FoodToIngredientConnection connection
   */
  edges?: Maybe<Array<Maybe<FoodToIngredientConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface FoodToIngredientConnectionEdge {
 ...
 * Connection between the food type and the food type
 */
export interface FoodToPreviewConnectionEdge {
...
export interface Ingredient {
  ...
  recipes: (args?: {
     ...
     */
    last?: Maybe<Scalars["Int"]>;
  }) => Maybe<IngredientToRecipeConnection>;
  /**
   * The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the ingredient type and the food type
 */
export interface IngredientToFoodConnectionEdge {
 ...
 * Connection between the ingredient type and the ingredient type
 */
export interface IngredientToPreviewConnectionEdge {
 ...
 * Connection between the ingredient type and the recipe type
 */
export interface IngredientToRecipeConnection {
  __typename?: "IngredientToRecipeConnection";
  /**
   * Edges for the IngredientToRecipeConnection connection
   */
  edges?: Maybe<Array<Maybe<IngredientToRecipeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Recipe>>>;
 ...
 * An edge in a connection
 */
export interface IngredientToRecipeConnectionEdge {
 ...
 */
export interface LoginWithCookiesPayload {
...
export interface Memo {
  ...
  categories: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<MemoToCategoryConnectionWhereArgs>;
  }) => Maybe<MemoToCategoryConnection>;
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
  ...
  tags: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<MemoToTagConnectionWhereArgs>;
  }) => Maybe<MemoToTagConnection>;
  /**
   * The template assigned to a node of content
   */
  template?: Maybe<ContentTemplate>;
  ...
  terms: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<MemoToTermNodeConnectionWhereArgs>;
  }) => Maybe<MemoToTermNodeConnection>;
  /**
   * The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made.
   */
  title: (args?: {
 ...
 * Connection between the Memo type and the category type
 */
export interface MemoToCategoryConnection {
  __typename?: "MemoToCategoryConnection";
  /**
   * Edges for the MemoToCategoryConnection connection
   */
  edges?: Maybe<Array<Maybe<MemoToCategoryConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Category>>>;
 ...
 * An edge in a connection
 */
export interface MemoToCategoryConnectionEdge {
 ...
 * Connection between the Memo type and the Memo type
 */
export interface MemoToPreviewConnectionEdge {
 ...
 * Connection between the Memo type and the tag type
 */
export interface MemoToTagConnection {
  __typename?: "MemoToTagConnection";
  /**
   * Edges for the MemoToTagConnection connection
   */
  edges?: Maybe<Array<Maybe<MemoToTagConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface MemoToTagConnectionEdge {
 ...
 * Connection between the Memo type and the TermNode type
 */
export interface MemoToTermNodeConnection {
  __typename?: "MemoToTermNodeConnection";
  /**
   * Edges for the MemoToTermNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<MemoToTermNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface MemoToTermNodeConnectionEdge {
 ...
 * Field Group
 */
export interface Memo_Memos {
  __typename?: "Memo_Memos";
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
  memoArchived?: Maybe<ScalarsEnums["Boolean"]>;
  memoCategory?: Maybe<ScalarsEnums["String"]>;
  memoContent?: Maybe<ScalarsEnums["String"]>;
  memoExcerpt?: Maybe<ScalarsEnums["String"]>;
  memoImportance?: Maybe<ScalarsEnums["Float"]>;
  memoScore?: Maybe<ScalarsEnums["Float"]>;
}
...
export interface Mynote {
  ...
  noteCategories: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<MynoteToNoteCategoryConnectionWhereArgs>;
  }) => Maybe<MynoteToNoteCategoryConnection>;
  /**
   ...
   * This field can be used to change the sorting order
   */
  sortingOrder?: Maybe<ScalarsEnums["Float"]>;
  /**
   * The current status of the object
   */
  status?: Maybe<ScalarsEnums["String"]>;
  ...
  terms: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<MynoteToTermNodeConnectionWhereArgs>;
  }) => Maybe<MynoteToTermNodeConnection>;
  /**
   * The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made.
   */
  title: (args?: {
 ...
 * Connection between the mynote type and the noteCategory type
 */
export interface MynoteToNoteCategoryConnection {
  __typename?: "MynoteToNoteCategoryConnection";
  /**
   * Edges for the MynoteToNoteCategoryConnection connection
   */
  edges?: Maybe<Array<Maybe<MynoteToNoteCategoryConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<NoteCategory>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface MynoteToNoteCategoryConnectionEdge {
   ...
   * The item at the end of the edge
   */
  node?: Maybe<NoteCategory>;
}

/**
 * Connection between the mynote type and the mynote type
 */
export interface MynoteToPreviewConnectionEdge {
 ...
 * Connection between the mynote type and the TermNode type
 */
export interface MynoteToTermNodeConnection {
  __typename?: "MynoteToTermNodeConnection";
  /**
   * Edges for the MynoteToTermNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<MynoteToTermNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<TermNode>>>;
 ...
 * An edge in a connection
 */
export interface MynoteToTermNodeConnectionEdge {
...
export interface NodeWithContentEditor {
  __typename?: "Memo" | "Note" | "Page" | "Post";
  /**
   * The content of the post.
   */
  content: (args?: {
...
export interface NodeWithFeaturedImage {
  __typename?: "Memo" | "Page" | "Post" | "Recipe";
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
...
export interface Note {
  ...
  categories: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<NoteToCategoryConnectionWhereArgs>;
  }) => Maybe<NoteToCategoryConnection>;
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
  ...
  tags: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<NoteToTagConnectionWhereArgs>;
  }) => Maybe<NoteToTagConnection>;
  /**
   * The template assigned to the node
   */
  template?: Maybe<ContentTemplate>;
  ...
  terms: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<NoteToTermNodeConnectionWhereArgs>;
  }) => Maybe<NoteToTermNodeConnection>;
  /**
   * The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made.
   */
  title: (args?: {
...
export interface NoteCategory {
  ...
  contentNodes: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<NoteCategoryToContentNodeConnectionWhereArgs>;
  }) => Maybe<NoteCategoryToContentNodeConnection>;
  /**
   * The number of objects connected to the object
   */
  count?: Maybe<ScalarsEnums["Int"]>;
  ...
  mynotes: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<NoteCategoryToMynoteConnectionWhereArgs>;
  }) => Maybe<NoteCategoryToMynoteConnection>;
  /**
   * The human friendly name of the object.
   */
  name?: Maybe<ScalarsEnums["String"]>;
   ...
   * @deprecated Deprecated in favor of databaseId
   */
  noteCategoryId?: Maybe<ScalarsEnums["Int"]>;
  /**
   * An alphanumeric identifier for the object unique to its type.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the noteCategory type and the ContentNode type
 */
export interface NoteCategoryToContentNodeConnection {
  __typename?: "NoteCategoryToContentNodeConnection";
  /**
   * Edges for the NoteCategoryToContentNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<NoteCategoryToContentNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<ContentNode>>>;
 ...
 * An edge in a connection
 */
export interface NoteCategoryToContentNodeConnectionEdge {
 ...
 * Connection between the noteCategory type and the mynote type
 */
export interface NoteCategoryToMynoteConnection {
  __typename?: "NoteCategoryToMynoteConnection";
  /**
   * Edges for the NoteCategoryToMynoteConnection connection
   */
  edges?: Maybe<Array<Maybe<NoteCategoryToMynoteConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Mynote>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface NoteCategoryToMynoteConnectionEdge {
 ...
 * Connection between the noteCategory type and the Taxonomy type
 */
export interface NoteCategoryToTaxonomyConnectionEdge {
 ...
 * Connection between the Note type and the category type
 */
export interface NoteToCategoryConnection {
  __typename?: "NoteToCategoryConnection";
  /**
   * Edges for the NoteToCategoryConnection connection
   */
  edges?: Maybe<Array<Maybe<NoteToCategoryConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Category>>>;
 ...
 * An edge in a connection
 */
export interface NoteToCategoryConnectionEdge {
 ...
 * Connection between the Note type and the Note type
 */
export interface NoteToPreviewConnectionEdge {
 ...
 * Connection between the Note type and the tag type
 */
export interface NoteToTagConnection {
  __typename?: "NoteToTagConnection";
  /**
   * Edges for the NoteToTagConnection connection
   */
  edges?: Maybe<Array<Maybe<NoteToTagConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Tag>>>;
 ...
 * An edge in a connection
 */
export interface NoteToTagConnectionEdge {
 ...
 * Connection between the Note type and the TermNode type
 */
export interface NoteToTermNodeConnection {
  __typename?: "NoteToTermNodeConnection";
  /**
   * Edges for the NoteToTermNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<NoteToTermNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<TermNode>>>;
 ...
 * An edge in a connection
 */
export interface NoteToTermNodeConnectionEdge {
 ...
 * Field Group
 */
export interface Note_Noteacf {
  __typename?: "Note_Noteacf";
  acfCategory?: Maybe<ScalarsEnums["String"]>;
  acfDetails?: Maybe<ScalarsEnums["String"]>;
  acfImportance?: Maybe<ScalarsEnums["Float"]>;
  acfMakepublic?: Maybe<ScalarsEnums["Boolean"]>;
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
 ...
 * Field Group
 */
export interface Post_Acf {
  __typename?: "Post_Acf";
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
  imageCapture?: Maybe<ScalarsEnums["String"]>;
  markdown?: Maybe<ScalarsEnums["String"]>;
  markdownTest?: Maybe<ScalarsEnums["String"]>;
}
...
export interface Recipe {
  ...
  recipeIngredients: (args?: {
     ...
     */
    last?: Maybe<Scalars["Int"]>;
  }) => Maybe<RecipeToIngredientConnection>;
  /**
   * The URL of the recipe
   */
  recipeURL?: Maybe<ScalarsEnums["String"]>;
  /**
   * The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the recipe type and the creator type
 */
export interface RecipeToCreatorConnectionEdge {
 ...
 * Connection between the recipe type and the ingredient type
 */
export interface RecipeToIngredientConnection {
  __typename?: "RecipeToIngredientConnection";
  /**
   * Edges for the RecipeToIngredientConnection connection
   */
  edges?: Maybe<Array<Maybe<RecipeToIngredientConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Ingredient>>>;
 ...
 * An edge in a connection
 */
export interface RecipeToIngredientConnectionEdge {
 ...
 * Connection between the recipe type and the recipe type
 */
export interface RecipeToPreviewConnectionEdge {
 ...
 */
export interface RootQueryToBlogpostConnection {
 ...
 * An edge in a connection
 */
export interface RootQueryToBlogpostConnectionEdge {
 ...
 */
export interface RootQueryToCreatorConnection {
 ...
 * An edge in a connection
 */
export interface RootQueryToCreatorConnectionEdge {
 ...
 */
export interface RootQueryToFoodConnection {
  __typename?: "RootQueryToFoodConnection";
  /**
   * Edges for the RootQueryToFoodConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToFoodConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Food>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToFoodConnectionEdge {
 ...
 */
export interface RootQueryToIngredientConnection {
  __typename?: "RootQueryToIngredientConnection";
  /**
   * Edges for the RootQueryToIngredientConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToIngredientConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Ingredient>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToIngredientConnectionEdge {
 ...
 */
export interface RootQueryToMemoConnection {
  __typename?: "RootQueryToMemoConnection";
  /**
   * Edges for the RootQueryToMemoConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToMemoConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Memo>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToMemoConnectionEdge {
 ...
 */
export interface RootQueryToMynoteConnection {
  __typename?: "RootQueryToMynoteConnection";
  /**
   * Edges for the RootQueryToMynoteConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToMynoteConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Mynote>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToMynoteConnectionEdge {
 ...
 */
export interface RootQueryToNoteCategoryConnection {
  __typename?: "RootQueryToNoteCategoryConnection";
  /**
   * Edges for the RootQueryToNoteCategoryConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToNoteCategoryConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<NoteCategory>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToNoteCategoryConnectionEdge {
 ...
 */
export interface RootQueryToNoteConnection {
  __typename?: "RootQueryToNoteConnection";
  /**
   * Edges for the RootQueryToNoteConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToNoteConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Note>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToNoteConnectionEdge {
 ...
 */
export interface RootQueryToRecipeConnection {
 ...
 * An edge in a connection
 */
export interface RootQueryToRecipeConnectionEdge {
 ...
 */
export interface RootQueryToSnippetConnection {
  __typename?: "RootQueryToSnippetConnection";
  /**
   * Edges for the RootQueryToSnippetConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToSnippetConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface RootQueryToSnippetConnectionEdge {
 ...
 * Connection between the snippet type and the snippet type
 */
export interface SnippetToPreviewConnectionEdge {
...
export interface Tag {
  ...
  memos: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<TagToMemoConnectionWhereArgs>;
  }) => Maybe<TagToMemoConnection>;
  /**
   * The human friendly name of the object.
   */
  name?: Maybe<ScalarsEnums["String"]>;
  ...
  notes: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<TagToNoteConnectionWhereArgs>;
  }) => Maybe<TagToNoteConnection>;
  /**
 ...
 * Connection between the tag type and the Memo type
 */
export interface TagToMemoConnection {
  __typename?: "TagToMemoConnection";
  /**
   * Edges for the TagToMemoConnection connection
   */
  edges?: Maybe<Array<Maybe<TagToMemoConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Memo>>>;
 ...
 * An edge in a connection
 */
export interface TagToMemoConnectionEdge {
 ...
 * Connection between the tag type and the Note type
 */
export interface TagToNoteConnection {
  __typename?: "TagToNoteConnection";
  /**
   * Edges for the TagToNoteConnection connection
   */
  edges?: Maybe<Array<Maybe<TagToNoteConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Note>>>;
 ...
 * An edge in a connection
 */
export interface TagToNoteConnectionEdge {
...
export interface TermNode {
  __typename?: "Category" | "NoteCategory" | "PostFormat" | "Tag";
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
 ...
 */
export interface UpdateMynotePayload {
 ...
 */
export interface UpdateNoteCategoryPayload {
...
export interface User {
  ...
  }) => Maybe<UserToBlogpostConnection>;
  /**
  ...
  creators: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToCreatorConnectionWhereArgs>;
  }) => Maybe<UserToCreatorConnection>;
  /**
   * Identifies the primary key from the database.
   */
  databaseId: ScalarsEnums["Int"];
  ...
  foods: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToFoodConnectionWhereArgs>;
  }) => Maybe<UserToFoodConnection>;
  /**
  ...
  ingredients: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToIngredientConnectionWhereArgs>;
  }) => Maybe<UserToIngredientConnection>;
  /**
   * Whether the node is a Content Node
   */
  isContentNode: ScalarsEnums["Boolean"];
  ...
  mynotes: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToMynoteConnectionWhereArgs>;
  }) => Maybe<UserToMynoteConnection>;
  /**
  ...
  notes: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToNoteConnectionWhereArgs>;
  }) => Maybe<UserToNoteConnection>;
  /**
  ...
  snippets: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToSnippetConnectionWhereArgs>;
  }) => Maybe<UserToSnippetConnection>;
  templates?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * The unique resource identifier path
   */
 ...
 * Connection between the User type and the blogpost type
 */
export interface UserToBlogpostConnection {
 ...
 * An edge in a connection
 */
export interface UserToBlogpostConnectionEdge {
 ...
 * Connection between the User type and the creator type
 */
export interface UserToCreatorConnection {
  __typename?: "UserToCreatorConnection";
  /**
   * Edges for the UserToCreatorConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToCreatorConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Creator>>>;
 ...
 * An edge in a connection
 */
export interface UserToCreatorConnectionEdge {
 ...
 * Connection between the User type and the food type
 */
export interface UserToFoodConnection {
  __typename?: "UserToFoodConnection";
  /**
   * Edges for the UserToFoodConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToFoodConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Food>>>;
 ...
 * An edge in a connection
 */
export interface UserToFoodConnectionEdge {
 ...
 * Connection between the User type and the ingredient type
 */
export interface UserToIngredientConnection {
  __typename?: "UserToIngredientConnection";
  /**
   * Edges for the UserToIngredientConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToIngredientConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Ingredient>>>;
 ...
 * An edge in a connection
 */
export interface UserToIngredientConnectionEdge {
 ...
 * Connection between the User type and the mynote type
 */
export interface UserToMynoteConnection {
  __typename?: "UserToMynoteConnection";
  /**
   * Edges for the UserToMynoteConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToMynoteConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Mynote>>>;
 ...
 * An edge in a connection
 */
export interface UserToMynoteConnectionEdge {
 ...
 * Connection between the User type and the Note type
 */
export interface UserToNoteConnection {
  __typename?: "UserToNoteConnection";
  /**
   * Edges for the UserToNoteConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToNoteConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Note>>>;
 ...
 * An edge in a connection
 */
export interface UserToNoteConnectionEdge {
 ...
 * Connection between the User type and the recipe type
 */
export interface UserToRecipeConnection {
 ...
 * An edge in a connection
 */
export interface UserToRecipeConnectionEdge {
 ...
 * Connection between the User type and the snippet type
 */
export interface UserToSnippetConnection {
  __typename?: "UserToSnippetConnection";
  /**
   * Edges for the UserToSnippetConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToSnippetConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Snippet>>>;
 ...
 * An edge in a connection
 */
export interface UserToSnippetConnectionEdge {
...
export interface Mutation {
  ...
  }) => Maybe<CreateCreatorPayload>;
  createFood: (args: { input: CreateFoodInput }) => Maybe<CreateFoodPayload>;
  createIngredient: (args: {
    input: CreateIngredientInput;
  }) => Maybe<CreateIngredientPayload>;
  createMediaItem: (args: {
    input: CreateMediaItemInput;
  }) => Maybe<CreateMediaItemPayload>;
  createMemo: (args: { input: CreateMemoInput }) => Maybe<CreateMemoPayload>;
  createMynote: (args: {
    input: CreateMynoteInput;
  }) => Maybe<CreateMynotePayload>;
  createNote: (args: { input: CreateNoteInput }) => Maybe<CreateNotePayload>;
  createNoteCategory: (args: {
    input: CreateNoteCategoryInput;
  }) => Maybe<CreateNoteCategoryPayload>;
  ...
  }) => Maybe<CreateRecipePayload>;
  createSnippet: (args: {
    input: CreateSnippetInput;
  }) => Maybe<CreateSnippetPayload>;
  ...
  }) => Maybe<DeleteCreatorPayload>;
  deleteFood: (args: { input: DeleteFoodInput }) => Maybe<DeleteFoodPayload>;
  deleteIngredient: (args: {
    input: DeleteIngredientInput;
  }) => Maybe<DeleteIngredientPayload>;
  deleteMediaItem: (args: {
    input: DeleteMediaItemInput;
  }) => Maybe<DeleteMediaItemPayload>;
  deleteMemo: (args: { input: DeleteMemoInput }) => Maybe<DeleteMemoPayload>;
  deleteMynote: (args: {
    input: DeleteMynoteInput;
  }) => Maybe<DeleteMynotePayload>;
  deleteNote: (args: { input: DeleteNoteInput }) => Maybe<DeleteNotePayload>;
  deleteNoteCategory: (args: {
    input: DeleteNoteCategoryInput;
  }) => Maybe<DeleteNoteCategoryPayload>;
  ...
  }) => Maybe<DeleteRecipePayload>;
  deleteSnippet: (args: {
    input: DeleteSnippetInput;
  }) => Maybe<DeleteSnippetPayload>;
  ...
  loginWithCookies: (args: {
    input: LoginWithCookiesInput;
  }) => Maybe<LoginWithCookiesPayload>;
  logout: (args: { input: LogoutInput }) => Maybe<LogoutPayload>;
  registerUser: (args: {
  ...
  }) => Maybe<UpdateCreatorPayload>;
  updateFood: (args: { input: UpdateFoodInput }) => Maybe<UpdateFoodPayload>;
  updateIngredient: (args: {
    input: UpdateIngredientInput;
  }) => Maybe<UpdateIngredientPayload>;
  updateMediaItem: (args: {
    input: UpdateMediaItemInput;
  }) => Maybe<UpdateMediaItemPayload>;
  updateMemo: (args: { input: UpdateMemoInput }) => Maybe<UpdateMemoPayload>;
  updateMynote: (args: {
    input: UpdateMynoteInput;
  }) => Maybe<UpdateMynotePayload>;
  updateNote: (args: { input: UpdateNoteInput }) => Maybe<UpdateNotePayload>;
  updateNoteCategory: (args: {
    input: UpdateNoteCategoryInput;
  }) => Maybe<UpdateNoteCategoryPayload>;
  ...
  }) => Maybe<UpdateRecipePayload>;
  updateSettings: (args: {
    input: UpdateSettingsInput;
  }) => Maybe<UpdateSettingsPayload>;
  updateSnippet: (args: {
    input: UpdateSnippetInput;
  }) => Maybe<UpdateSnippetPayload>;
...
export interface Query {
  ...
  }) => Maybe<RootQueryToBlogpostConnection>;
  categories: (args?: {
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    first?: Maybe<Scalars["Int"]>;
  ...
  creators: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToCreatorConnectionWhereArgs>;
  }) => Maybe<RootQueryToCreatorConnection>;
  discussionSettings?: Maybe<DiscussionSettings>;
  food: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<FoodIdType>;
  }) => Maybe<Food>;
  foodBy: (args?: {
  ...
  foods: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToFoodConnectionWhereArgs>;
  }) => Maybe<RootQueryToFoodConnection>;
  generalSettings?: Maybe<GeneralSettings>;
  ingredient: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<IngredientIdType>;
  }) => Maybe<Ingredient>;
  ingredientBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
  ...
  ingredients: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToIngredientConnectionWhereArgs>;
  }) => Maybe<RootQueryToIngredientConnection>;
  mediaItem: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
  ...
  memos: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToMemoConnectionWhereArgs>;
  }) => Maybe<RootQueryToMemoConnection>;
  menu: (args: {
    id: Scalars["ID"];
  ...
  mynote: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<MynoteIdType>;
  }) => Maybe<Mynote>;
  mynoteBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
    mynoteId?: Maybe<Scalars["Int"]>;
    slug?: Maybe<Scalars["String"]>;
    uri?: Maybe<Scalars["String"]>;
  }) => Maybe<Mynote>;
  mynotes: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToMynoteConnectionWhereArgs>;
  }) => Maybe<RootQueryToMynoteConnection>;
  ...
  noteCategories: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToNoteCategoryConnectionWhereArgs>;
  }) => Maybe<RootQueryToNoteCategoryConnection>;
  noteCategory: (args: {
    id: Scalars["ID"];
    idType?: Maybe<NoteCategoryIdType>;
  }) => Maybe<NoteCategory>;
  notes: (args?: {
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToNoteConnectionWhereArgs>;
  }) => Maybe<RootQueryToNoteConnection>;
  page: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
  ...
  }) => Maybe<RootQueryToRecipeConnection>;
  ...
  snippet: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
    idType?: Maybe<SnippetIdType>;
  }) => Maybe<Snippet>;
  snippetBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
    slug?: Maybe<Scalars["String"]>;
    snippetId?: Maybe<Scalars["Int"]>;
    uri?: Maybe<Scalars["String"]>;
  }) => Maybe<Snippet>;
  snippets: (args?: {
    after?: Maybe<Scalars["String"]>;
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToSnippetConnectionWhereArgs>;
  }) => Maybe<RootQueryToSnippetConnection>;
...
export interface SchemaObjectTypes {
  ...
  CategoryToMemoConnection: CategoryToMemoConnection;
  CategoryToMemoConnectionEdge: CategoryToMemoConnectionEdge;
  CategoryToNoteConnection: CategoryToNoteConnection;
  CategoryToNoteConnectionEdge: CategoryToNoteConnectionEdge;
  ...
  CreateBlogpostPayload: CreateBlogpostPayload;
  ...
  CreateFoodPayload: CreateFoodPayload;
  CreateIngredientPayload: CreateIngredientPayload;
  CreateMediaItemPayload: CreateMediaItemPayload;
  CreateMemoPayload: CreateMemoPayload;
  CreateMynotePayload: CreateMynotePayload;
  CreateNoteCategoryPayload: CreateNoteCategoryPayload;
  ...
  Creator: Creator;
  CreatorToPreviewConnectionEdge: CreatorToPreviewConnectionEdge;
  CreatorToRecipeConnection: CreatorToRecipeConnection;
  CreatorToRecipeConnectionEdge: CreatorToRecipeConnectionEdge;
  DefaultTemplate: DefaultTemplate;
  DeleteBlogpostPayload: DeleteBlogpostPayload;
  DeleteCategoryPayload: DeleteCategoryPayload;
  DeleteCommentPayload: DeleteCommentPayload;
  DeleteCreatorPayload: DeleteCreatorPayload;
  DeleteFoodPayload: DeleteFoodPayload;
  DeleteIngredientPayload: DeleteIngredientPayload;
  DeleteMediaItemPayload: DeleteMediaItemPayload;
  DeleteMemoPayload: DeleteMemoPayload;
  DeleteMynotePayload: DeleteMynotePayload;
  DeleteNoteCategoryPayload: DeleteNoteCategoryPayload;
  ...
  DeleteRecipePayload: DeleteRecipePayload;
  ...
  Food: Food;
  FoodToIngredientConnection: FoodToIngredientConnection;
  FoodToIngredientConnectionEdge: FoodToIngredientConnectionEdge;
  FoodToPreviewConnectionEdge: FoodToPreviewConnectionEdge;
  ...
  Ingredient: Ingredient;
  IngredientToFoodConnectionEdge: IngredientToFoodConnectionEdge;
  IngredientToPreviewConnectionEdge: IngredientToPreviewConnectionEdge;
  IngredientToRecipeConnection: IngredientToRecipeConnection;
  IngredientToRecipeConnectionEdge: IngredientToRecipeConnectionEdge;
  LoginWithCookiesPayload: LoginWithCookiesPayload;
  ...
  MediaSize: MediaSize;
  Memo: Memo;
  MemoToCategoryConnection: MemoToCategoryConnection;
  MemoToCategoryConnectionEdge: MemoToCategoryConnectionEdge;
  MemoToPreviewConnectionEdge: MemoToPreviewConnectionEdge;
  MemoToTagConnection: MemoToTagConnection;
  MemoToTagConnectionEdge: MemoToTagConnectionEdge;
  MemoToTermNodeConnection: MemoToTermNodeConnection;
  MemoToTermNodeConnectionEdge: MemoToTermNodeConnectionEdge;
  Memo_Memos: Memo_Memos;
  Menu: Menu;
  MenuItem: MenuItem;
  ...
  Mutation: Mutation;
  Mynote: Mynote;
  MynoteToNoteCategoryConnection: MynoteToNoteCategoryConnection;
  MynoteToNoteCategoryConnectionEdge: MynoteToNoteCategoryConnectionEdge;
  MynoteToPreviewConnectionEdge: MynoteToPreviewConnectionEdge;
  MynoteToTermNodeConnection: MynoteToTermNodeConnection;
  MynoteToTermNodeConnectionEdge: MynoteToTermNodeConnectionEdge;
  ...
  Note: Note;
  NoteCategory: NoteCategory;
  NoteCategoryToContentNodeConnection: NoteCategoryToContentNodeConnection;
  NoteCategoryToContentNodeConnectionEdge: NoteCategoryToContentNodeConnectionEdge;
  NoteCategoryToMynoteConnection: NoteCategoryToMynoteConnection;
  NoteCategoryToMynoteConnectionEdge: NoteCategoryToMynoteConnectionEdge;
  NoteCategoryToTaxonomyConnectionEdge: NoteCategoryToTaxonomyConnectionEdge;
  NoteToCategoryConnection: NoteToCategoryConnection;
  NoteToCategoryConnectionEdge: NoteToCategoryConnectionEdge;
  NoteToPreviewConnectionEdge: NoteToPreviewConnectionEdge;
  NoteToTagConnection: NoteToTagConnection;
  NoteToTagConnectionEdge: NoteToTagConnectionEdge;
  NoteToTermNodeConnection: NoteToTermNodeConnection;
  NoteToTermNodeConnectionEdge: NoteToTermNodeConnectionEdge;
  Note_Noteacf: Note_Noteacf;
  Page: Page;
  ...
  Recipe: Recipe;
  RecipeToCreatorConnectionEdge: RecipeToCreatorConnectionEdge;
  RecipeToIngredientConnection: RecipeToIngredientConnection;
  RecipeToIngredientConnectionEdge: RecipeToIngredientConnectionEdge;
  RecipeToPreviewConnectionEdge: RecipeToPreviewConnectionEdge;
  RegisterUserPayload: RegisterUserPayload;
  ResetUserPasswordPayload: ResetUserPasswordPayload;
  RestoreCommentPayload: RestoreCommentPayload;
  RootQueryToBlogpostConnection: RootQueryToBlogpostConnection;
  RootQueryToBlogpostConnectionEdge: RootQueryToBlogpostConnectionEdge;
  ...
  RootQueryToCreatorConnection: RootQueryToCreatorConnection;
  RootQueryToCreatorConnectionEdge: RootQueryToCreatorConnectionEdge;
  ...
  RootQueryToFoodConnection: RootQueryToFoodConnection;
  RootQueryToFoodConnectionEdge: RootQueryToFoodConnectionEdge;
  RootQueryToIngredientConnection: RootQueryToIngredientConnection;
  RootQueryToIngredientConnectionEdge: RootQueryToIngredientConnectionEdge;
  ...
  RootQueryToMemoConnection: RootQueryToMemoConnection;
  RootQueryToMemoConnectionEdge: RootQueryToMemoConnectionEdge;
  ...
  RootQueryToMynoteConnection: RootQueryToMynoteConnection;
  RootQueryToMynoteConnectionEdge: RootQueryToMynoteConnectionEdge;
  RootQueryToNoteCategoryConnection: RootQueryToNoteCategoryConnection;
  RootQueryToNoteCategoryConnectionEdge: RootQueryToNoteCategoryConnectionEdge;
  RootQueryToNoteConnection: RootQueryToNoteConnection;
  RootQueryToNoteConnectionEdge: RootQueryToNoteConnectionEdge;
  ...
  RootQueryToRecipeConnection: RootQueryToRecipeConnection;
  RootQueryToRecipeConnectionEdge: RootQueryToRecipeConnectionEdge;
  RootQueryToSnippetConnection: RootQueryToSnippetConnection;
  RootQueryToSnippetConnectionEdge: RootQueryToSnippetConnectionEdge;
  ...
  Settings: Settings;
  Snippet: Snippet;
  SnippetToPreviewConnectionEdge: SnippetToPreviewConnectionEdge;
  Subscription: Subscription;
  Tag: Tag;
  TagToContentNodeConnection: TagToContentNodeConnection;
  TagToContentNodeConnectionEdge: TagToContentNodeConnectionEdge;
  TagToMemoConnection: TagToMemoConnection;
  TagToMemoConnectionEdge: TagToMemoConnectionEdge;
  TagToNoteConnection: TagToNoteConnection;
  TagToNoteConnectionEdge: TagToNoteConnectionEdge;
  ...
  UpdateFoodPayload: UpdateFoodPayload;
  UpdateIngredientPayload: UpdateIngredientPayload;
  UpdateMediaItemPayload: UpdateMediaItemPayload;
  UpdateMemoPayload: UpdateMemoPayload;
  UpdateMynotePayload: UpdateMynotePayload;
  UpdateNoteCategoryPayload: UpdateNoteCategoryPayload;
  ...
  User: User;
  UserRole: UserRole;
  UserToBlogpostConnection: UserToBlogpostConnection;
  UserToBlogpostConnectionEdge: UserToBlogpostConnectionEdge;
  ...
  UserToCreatorConnection: UserToCreatorConnection;
  UserToCreatorConnectionEdge: UserToCreatorConnectionEdge;
  ...
  UserToFoodConnection: UserToFoodConnection;
  UserToFoodConnectionEdge: UserToFoodConnectionEdge;
  UserToIngredientConnection: UserToIngredientConnection;
  UserToIngredientConnectionEdge: UserToIngredientConnectionEdge;
  UserToMediaItemConnection: UserToMediaItemConnection;
  UserToMediaItemConnectionEdge: UserToMediaItemConnectionEdge;
  UserToMynoteConnection: UserToMynoteConnection;
  UserToMynoteConnectionEdge: UserToMynoteConnectionEdge;
  UserToNoteConnection: UserToNoteConnection;
  UserToNoteConnectionEdge: UserToNoteConnectionEdge;
  ...
  UserToRecipeConnection: UserToRecipeConnection;
  UserToRecipeConnectionEdge: UserToRecipeConnectionEdge;
  UserToSnippetConnection: UserToSnippetConnection;
  UserToSnippetConnectionEdge: UserToSnippetConnectionEdge;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  BlogpostIdType: BlogpostIdType | undefined;
  ...
  ContentTypesOfNoteCategoryEnum: ContentTypesOfNoteCategoryEnum | undefined;
  ContentTypesOfPostFormatEnum: ContentTypesOfPostFormatEnum | undefined;
  ContentTypesOfTagEnum: ContentTypesOfTagEnum | undefined;
  CreatorIdType: CreatorIdType | undefined;
  FoodIdType: FoodIdType | undefined;
  IngredientIdType: IngredientIdType | undefined;
  ...
  MemoIdType: MemoIdType | undefined;
  ...
  MynoteIdType: MynoteIdType | undefined;
  NoteCategoryIdType: NoteCategoryIdType | undefined;
  NoteIdType: NoteIdType | undefined;
  ...
  RecipeIdType: RecipeIdType | undefined;
  RelationEnum: RelationEnum | undefined;
  SnippetIdType: SnippetIdType | undefined;
